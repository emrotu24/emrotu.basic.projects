...
export default function Overview() {
    ...
    useEffect(() => {
        const handleResize = () => {
            ...
            setIsLargeScreen(isNowLarge);

            if (isNowLarge) {
            // Pausa tutti i video visibili
...
{/* INTRODUCTION SECTION */}
            <section className="introduction-box relative overflow-hidden group bg-cover bg-no-repeat bg-center py-6 lg:py-24"
...
{/* PROJECTS SECTION */}
                <div
                    className="last-proyects-box flex flex-col justify-center text-center min-h-52 lg:min-h-64 w-full relative group hover:scale-105 overflow-hidden rounded-lg shadow-lg cursor-pointer"
                    ...
                    <video
                        src={LastProjectsBg}
                        className="responsive-video absolute top-0 left-0 w-full h-full object-cover z-0"
                        muted
                        loop
                        playsInline
...
{/* WORKING PROGRESS SECTION */}
                <div
                    className="working-progress-box flex flex-col items-center justify-center text-center min-h-52 lg:min-h-64 w-full relative group hover:scale-105 overflow-hidden rounded-lg shadow-lg cursor-pointer"
...
{/* KNOW ME BETTER SECTION */}
                <div
                    className="know-me-better-box flex flex-col items-center justify-center text-center min-h-52 lg:col-span-2 lg:min-h-64 w-full relative group hover:scale-105 overflow-hidden rounded-lg shadow-lg cursor-pointer"
